    ...
    <?php else: ?>
        <div class="space-y-6">
            <?php $__currentLoopData = $incidents; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $incident): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                <div class="feed-card hover:shadow-md transition-shadow">
                    <div class="flex items-start justify-between mb-4">
                        <div class="flex items-start space-x-4">
                            <?php if($incident->photo): ?>
                                <div class="w-24 h-24 rounded-lg overflow-hidden flex-shrink-0">
                                    <img src="<?php echo e(asset('storage/' . $incident->photo)); ?>" 
                                         alt="Incident photo" 
                            ...
                            <div>
                                <div class="flex items-center space-x-3">
                                    <h3 class="text-lg font-semibold text-gray-800"><?php echo e(ucfirst($incident->type)); ?></h3>
                                    <span class="px-2.5 py-0.5 text-xs font-medium rounded-full <?php echo e($incident->status === 'resolved' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800'); ?>">
                                        <?php echo e(ucfirst($incident->status)); ?>

                                    </span>
                                </div>
                                <p class="text-gray-600 mt-1"><?php echo e(Str::limit($incident->description, 200)); ?></p>
                                <div class="flex items-center text-sm text-gray-500 mt-2">
                                    <i class="fas fa-map-marker-alt mr-1.5 text-gray-400"></i>
                                    <span>Lat: <?php echo e($incident->latitude); ?>, Lng: <?php echo e($incident->longitude); ?></span>
                                    <span class="mx-2">•</span>
                                    <i class="far fa-calendar-alt mr-1.5 text-gray-400"></i>
                                    <span><?php echo e($incident->created_at->format('d/m/Y H:i')); ?></span>
                                </div>
                            </div>
                        </div>
                        <a href="<?php echo e(route('citizen.incidents.show', $incident)); ?>" class="text-sm font-medium text-purple-600 hover:text-purple-800 flex items-center">
                            Voir les détails
