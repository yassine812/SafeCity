                        ...
                        <div class="flex items-start space-x-4">
                            ...
                            <div>
                                <div class="flex items-center space-x-3">
                                    <h3 class="text-lg font-semibold text-gray-800">{{ ucfirst($incident->type) }}</h3>
                                    <span class="px-2.5 py-0.5 text-xs font-medium rounded-full {{ $incident->status === 'resolved' ? 'bg-green-100 text-green-800' : 'bg-yellow-100 text-yellow-800' }}">
                                        {{ ucfirst($incident->status) }}
                                    </span>
                                </div>
                                <p class="text-gray-600 mt-1">{{ Str::limit($incident->description, 200) }}</p>
                                <div class="flex items-center text-sm text-gray-500 mt-2">
                                    ...
                                    <span>{{ $incident->created_at->format('d/m/Y H:i') }}</span>
                                </div>
                            </div>
                        </div>
                        <a href="{{ route('citizen.incidents.show', $incident) }}" class="text-sm font-medium text-purple-600 hover:text-purple-800 flex items-center">
                            Voir les détails
